...
// Usar o composable de gerenciamento de modais
...
// Watch para controlar o estado do modal
watch(() => props.modelValue, (isOpen, wasOpen) => {
  if (isOpen && !wasOpen) {
    // Modal está abrindo
    registerModal(modalId)
    
    // Setup ESC key listener (apenas para o modal ativo)
    ...
    if (typeof document !== 'undefined' && escapeHandler) {
